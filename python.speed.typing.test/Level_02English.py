...
class Level02:
    ...
    def __init__(self):
        ...
        self.gui.geometry('900x600+350+50')
        ...
        self.wordlabel = Label(self.gui, text='', font=('black copper', 20, ' bold'), bg='#286ED3',fg= 'white')
        self.wordlabel.place(x=440, y=370, anchor=CENTER)

        self.title = Label(self.gui, text='Congratulations!, and Welcome to Level 02', bg = "#286ED3", font = ("Comic Sans MS", 25, "bold"), width = 35, fg = "white")
        self.title.place(x=100, y=77)

        self.scorelabel = Label(self.gui, text='Sentences', font=('Casteller', 28, 'bold'), bg='#286ED3',fg= 'white')
        self.scorelabel.place(x=75, y=160)

        self.scorelabelcount = Label(self.gui, text=self.i, font=('Casteller', 28, ' bold'), bg='#286ED3',fg= 'white')
        self.scorelabelcount.place(x=155, y=220)

        self.timelabel = Label(self.gui, text='Timer', font=('Casteller', 28, 'bold'), bg='#286ED3',fg= 'white')
        self.timelabel.place(x=680, y=160)

        self.timelabelcount = Label(self.gui, text=self.timeleft, font=('Casteller', 28, 'bold'), bg='#286ED3',fg= 'white')
        self.timelabelcount.place(x=720, y=220)

        self.gameplay_detaillabel = Label(self.gui, text='Type Sentence And Hit ENTER to Start', font=('Chiller', 25, ' bold'),  bg='#286ED3',fg= 'white')
        ...
        #Next Level Button
        self.next_level_button = Button(self.gui, text = "NEXT", command = next_level, image = self.next_image, compound = LEFT, bg = "White", font = ("Comic Sans MS", 15, "bold"), width = 100, fg = "Black")
        
        #Retry Image
        self.retry_image = PhotoImage(file="Retry.png")
        #Retry Button
        self.retry_button = Button(self.gui, text = "Retry", command = retry, image = self.retry_image, compound = RIGHT, bg = "White", font = ("Comic Sans MS", 15, "bold"), width = 100, fg = "Black")
        
        #Home Image
        home_image = PhotoImage(file="Home.png")
        #Home Button
        home_button = Button(self.gui, text = "Home", command = home, image = home_image, compound = LEFT, bg = "White", font = ("Comic Sans MS", 15, "bold"), width = 100, fg = "Black")
    ...
    def game_timer(self):
        ...
        if self.timeleft > 0:
            ...
            self.new_title = Label(self.gui, text = "TIME IS UP", bg = "#286ED3", font = ("Comic Sans MS", 50, "bold"), fg = "white")
            self.new_title.place(x = 240, y = 255)
