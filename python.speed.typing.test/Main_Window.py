...
class Main_Window:
    ...
    def __init__(GUI0):
        ...
        # Title
        GUI0.Title = Label(GUI0.window0, text = "", bg = "#286ED3", font = ("Comic Sans MS", 25, "bold"), width = 35, fg = "white")
        ...
        def start():
            ...
            english_button = Button(GUI0.window0, text = "English", command = english, bg = "White", font = ("Comic Sans MS", 25, "bold"), width = 10, fg = "Black")
            english_button.place(x = 150, y = 400)
            arabic_button = Button(GUI0.window0, text = "Arabic", command = arabic, bg = "White", font = ("Comic Sans MS", 25, "bold"), width = 10, fg = "Black")
            arabic_button.place(x = 550, y = 400)
        
        #Start Button
        start_button = Button(GUI0.window0, text = "START", command = start, bg = "White", font = ("Comic Sans MS", 25, "bold"), width = 10, fg = "Black")
